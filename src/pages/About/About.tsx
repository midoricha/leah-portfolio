...
function About() {
    const timelineItems = [
        ...
        {
            time: "2017",
            label: "Moved to Australia to study Digital Media @ University of Queensland 👩‍🎨",
        },
        {
            time: "2022",
            label: "Started a new chapter in Canada — Computer Science 💻",
        },
        ...
        <Box className="about-container">
            ...
            <Box className="about-hero">
                ...
                <Box className="intro-section">
                    <Box>
                        <img
                            src={`${import.meta.env.BASE_URL}girlandcat.png`}
                            alt="My icon"
                            width="400px"
                        />
                    </Box>
                    <Box className="about-intro-wrapper">
                        <Typography variant="body2" className="about-intro">
                            Hi, I'm Leah — a full-stack developer and visual
                            designer who loves crafting delightful digital
                            experiences. With a background in digital media and
                            computer science, I merge creative intuition with
                            technical precision to build interfaces that are as
                            functional as they are beautiful.
                        </Typography>
                        <br />
                        <Typography variant="body2" className="about-intro">
                            From turning design mockups into living, breathing
                            apps to optimizing back-end logic, I enjoy working
                            across the stack. I've studied and worked across
                            continents, and every project I take on reflects my
                            curiosity and care for design detail.
                        </Typography>
                        <br />
                        <Typography variant="body2" className="about-intro">
                            When I’m not building web apps, you’ll find me
                            brewing coffee, being a cat mom, or baking.
                        </Typography>
                    </Box>
                </Box>
            </Box>
